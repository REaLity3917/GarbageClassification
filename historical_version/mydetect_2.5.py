...
class CameraUI(QWidget):
    ...
    def detectUI(self):
        ...
        self.label0.setGeometry(940, 50, 70, 30)
        ...
        self.label1.setGeometry(940, 100, 70, 30)
        ...
        self.label2.setGeometry(940, 150, 70, 30)
        ...
        self.label3.setGeometry(940, 200, 70, 30)
    ...
    def change_txt(self):
        ...
        if len(self.detect_process.retu) < len(self.last_wastes):
            ...
            for a in self.txt2:
                ...
                if 'kitchen' in a:
                    self.kk += 1
                    self.retxt2.append(f'{mi}厨余垃圾     {self.kk}--OK\n')
                elif 'hazardous' in a:
                    self.hh += 1
                    self.retxt2.append(f'{mi}有害垃圾     {self.hh}--OK\n')
                elif 'recyclable waste' in a:
                    self.rr += 1
                    self.retxt2.append(f'{mi}可回收垃圾   {self.rr}--OK\n')
                elif 'other waste' in a:
                    self.ee += 1
                    self.retxt2.append(f'{mi}其他垃圾     {self.ee}--OK\n')
                ...
                while True:
                    ...
                    # if res:
                        ...
                        if res or time.time()-T>2:
                            ...
                            elif res == b'\x01' or time.time()-T>2:
                                ser_status = 1
                                shared_value.value = 1
...
class yolov5_detect():
    def __init__(self ,weights='best.pt', device='cpu', conf_thres=0.7, iou_thres=0.8):
        super().__init__()
